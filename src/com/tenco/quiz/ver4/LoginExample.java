...
public class LoginExample {
	...
	// private static final Logger LOGGER = Logger.getLogger("LoginExample"); 
	// --> 밑의 코드와 동일하나 대부분 밑의 코드를 사용함.
	...
	private static boolean authenticateUser(Connection conn, String username, String password) {
		...
		try {
			...
			result = rs.next();// 여기서 읽어들여서 result에 값을 담음.
		} catch (Exception e) {
			e.printStackTrace();
		}
		return result; // 입력한 값이 동일하면 true를 반환. 
	}
}// end of class
